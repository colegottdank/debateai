        ...
        >
          ...
          <div className="px-6 py-5 border-b border-[var(--border)]">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-lg font-semibold text-[var(--text)]">Share this debate</h2>
              ...
              <button 
                onClick={onClose}
                className="p-2 rounded-lg text-[var(--text-tertiary)] hover:text-[var(--text)] hover:bg-[var(--bg-sunken)] transition-colors"
              >
          ...
          <div className="px-6 py-4 bg-[var(--bg-sunken)]/50">
            <div className="p-4 rounded-xl bg-[var(--bg)] border border-[var(--border)]/50">
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-[var(--accent)] to-[var(--accent-light)] flex items-center justify-center">
          ...
          <div className="px-6 pb-6">
            ...
            <div className="flex gap-2">
              <div className="flex-1 px-4 py-2.5 rounded-xl bg-[var(--bg-sunken)] border border-[var(--border)]/30 text-sm text-[var(--text-secondary)] truncate">
                {debateUrl}
              </div>
